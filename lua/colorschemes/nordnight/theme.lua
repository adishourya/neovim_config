...
local c = require("colorschemes/nordnight.colors")
...
theme.plugins = {
  ...
  -- Indentlines
  black_ind = {fg=c.black_il},
  grey_ind = {fg=c.grey_il},
  yellow_ind = {fg=c.yellow_il},
  algea_ind = {fg=c.algea_il},
  aqua_ind = {fg=c.aqua_il},
